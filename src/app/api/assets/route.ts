...
export async function PATCH(req: NextRequest) {
  ...
  const allowed = ['stage', 'asset_name', 'content_type', 'file_name', 'status', 'date_added', 'date_live', 'first_live', 'posted_by', 'notes', 'product_id', 'performance', 'ad_only', 'campaigns', 'freshness_state', 'freshness_detail', 'freshness_scored_at']
