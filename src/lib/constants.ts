...
export const PRODUCT_CODES: Record<string, string> = {
  ...
  // Chomps — Chomplings line
  CC: 'Chicken Chomplings', TC: 'Turkey Chomplings',
  OBC: 'Original Beef Chomplings', SSC: 'Sea Salt Beef Chomplings',
  BBC: 'Smokey BBQ Chomplings', SBCC: 'Savory Breakfast Chomplings',
  ...
  CPB: 'Chocolate Peanut Butter', xCC: 'Cookies & Cream',
